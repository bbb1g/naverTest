...
audiop.MusicWebPlayerCoreConfig = {
    https: {
        ...
        playLogUrl : "http://audioapi.nmv.naver.com/pc", // �ъ깮濡쒓렇 url
        qualityLogUrl : "http://logapi.audiop.naver.com/quality.html", // �덉쭏濡쒓렇 url
        ...
        musicAPIStLog: "http://apis.naver.com/nmwebplayer/music/mobilewebmusic_stplay_trackStLog?log.serviceType={log.serviceType}&log.time={log.time}&log.trackId={log.trackId}&log.recordTime={log.recordTime}&log.totalTime={log.totalTime}&log.token={log.token}&log.info={log.info}&deviceId={deviceId}",
