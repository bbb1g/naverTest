...
! function(e) {
        ...
        function o(e, t) {
            if (p.AUDIO_TYPE.MUSIC_META == e) {
                var n = c.default.format({
                    ...
                    loginCheckAPIUrl: "http://apis.naver.com/musicpcplayer/musicapiweb/nid/loginInfo",
                    tracksAPIUrl: "http://apis.naver.com/musicpcplayer/musicapiweb/tracks/%s",
                    myalbumsAPIUrl: "http://apis.naver.com/musicpcplayer/musicapiweb/myMusic/myAlbums",
                    myalbumTrackPutAPIUrl: "http://apis.naver.com/musicpcplayer/musicapiweb/myMusic/myAlbum/%d/tracks/%s",
                    myalbumTracksUrl: "http://apis.naver.com/musicpcplayer/musicapiweb/myMusic/myAlbum/%s/tracks?start=1&display=%s",
                    ...
                    defaultCoverImageUrl: "http://ssl.pstatic.net/static/music/images/no_img_154.gif",
                    defaultPlaylistImageUrl: "http://ssl.pstatic.net/static/music/images/no_img_40.gif",
                    ...
                    loginUrl: "http://nid.naver.com/nidlogin.login?svctype=64&url=http%3A%2F%2Fmusic.naver.com%2Fapi%2FplayerLogin.nhn",
                    logoutUrl: "http://nid.naver.com/login/logout.nhn",
                    realnameCheckUrl: "http://nid.naver.com/user2/help/realNameCheck.nhn?a_version=2&type=11&surl=http%3A%2F%2Fmusic.naver.com&rurl=http%3A%2F%2Fmusic.naver.com",
                    legacyPlaylistAPIUrl: "http://player.music.naver.com/api.nhn?m=cookie_playlist"
                }.lyricPopupUrl, t);
    ...
    function(e, t, n) {
        ...
        function o(e, t) {
            var n = e.ref;
            return a.default("string" != typeof n, "Cannot connect React DnD to an element with an existing string ref. Please convert it to use a callback ref instead, or wrap it into a <span> or <div>. Read more: http://facebook.github.io/react/docs/more-about-refs.html#the-ref-callback-attribute"), n ? s.cloneElement(e, {
                ref: function(e) {
                    t(e), n && n(e)
                }
            }) : s.cloneElement(e, {
